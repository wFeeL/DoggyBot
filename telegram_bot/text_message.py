...
🔋 Для <b>максимальной заботы</b>, в разделе «консультация» можно оформить <b>VIP подписку</b>.
🤫 Это отличная <b>идея для подарка!</b>\n
<b>🎟 Промокоды:</b>
...
❓Напишите мне @doggy_logy <b>вопрос</b> текстом и ваш индивидуальный <b>промокод</b> (<code>{promo_code}</code>)."""
